...
public interface SNumbers{
    ...
    /**
     * Devuelve como es la resta entre un numero de Scrabble al ser sustraido a un decimal de Scrabble.
     */
    SNumbers subtractFloat(scrabbleFloat sF);
    /**
     * Devuelve como es la resta entre un numero de Scrabble al ser sustraido a  un binario de Scrabble.
     */
    ...
    /**
     * Devuelve como es la multiplicacion entre un entero de Scrabble al multiplicarsele un numero de Scrabble.
     */
    SNumbers multiplyInt(scrabbleInt sI);
    /**
     * Devuelve como es la multiplicacion entre un decimal de Scrabble al multiplicarsele un numero de Scrabble.
     */
    SNumbers multiplyFloat(scrabbleFloat sF);
    /**
     * Devuelve como es la multiplicacion entre un binario de Scrabble al multiplicarsele un numero de Scrabble.
     */
    ...
    /**
     * Devuelve como es la division entre un entero de Scrabble ser dividido por un numero de Scrabble.
     */
    SNumbers divideInt(scrabbleInt sI);
    /**
     * Devuelve como es la division entre un decimal de Scrabble ser dividido por un numero de Scrabble.
     */
    SNumbers divideFloat(scrabbleFloat sF);
    /**
     * Devuelve como es la division entre un binario de Scrabble ser dividido por un numero de Scrabble.
     */
